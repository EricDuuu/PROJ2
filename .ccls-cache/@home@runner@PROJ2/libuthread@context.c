...
void *uthread_ctx_alloc_stack(void) { return malloc(UTHREAD_STACK_SIZE); }

void uthread_ctx_destroy_stack(void *top_of_stack) { free(top_of_stack); }
...
int uthread_ctx_init(uthread_ctx_t *uctx, void *top_of_stack,
   ...
   */
  makecontext(uctx, (void (*)(void))uthread_ctx_bootstrap, 2, func, arg);
